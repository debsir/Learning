...
def display_structure(structure, parentparts=[]):
    ...
    # For a multipart part, print all of its subordinate part;
    # for other parts, print their dispostion (if available).
    if is_multipart:
        print
...
def explore_message(c, uid):
    """Let the user viw various parts of a given message."""
...
def explore_folder(c, name):
    """List the message in folder 'name' and let the user choose one."""
